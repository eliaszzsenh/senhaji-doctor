    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        >
          <div className={cn(
            ...
            >
              <path d="M12 20a10 10 0 1 1 0-20c5.523 0 10 4.477 10 10a1 1 0 0 1-1 1h-3a1 1 0 0 0-1 1v4a1 1 0 0 1-1 1H8a1 1 0 0 1-1-1v-4a1 1 0 0 0-1-1H3a1 1 0 0 1-1-1z" opacity="0" />
          ...
          <div className="flex flex-col leading-tight">
            ...
            <span className={cn("text-xs font-medium opacity-80", isScrolled ? "text-slate-500" : "text-slate-500 lg:text-white/80")}>Odontología</span>
          </div>
        </Link>
        ...
        {/* Mobile Menu Button */}
        <button
          className={cn("lg:hidden p-2 -mr-2", isScrolled ? "text-slate-900" : "text-slate-900 lg:text-white")}
      ...
      <div 
        className={cn(
          ...
          mobileMenuOpen ? "max-h-[400px] opacity-100 border-t border-slate-100" : "max-h-0 opacity-0"
        )}
      >
          ...
          {NAV_LINKS.map((link) => (
            <Link
              ...
              className={cn(
                ...
                location === link.href ? "bg-accent text-secondary" : "text-slate-700 hover:bg-slate-50"
              )}
            >
              {link.label}
            </Link>
